<template>
  <footer class="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 border-t border-gray-700 mt-16">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        ...
        <div class="col-span-1 md:col-span-1">
          <div class="flex items-center space-x-2 mb-4">
            ...
            <span class="text-2xl font-bold text-white">CodeArena</span>
          </div>
          <p class="text-gray-400 text-sm">
            Améliorez vos compétences en programmation à travers des défis passionnants.
          </p>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li>
              <RouterLink to="/contests" class="text-gray-400 hover:text-blue-400 transition-colors text-sm">
                Concours
              </RouterLink>
            </li>
            <li>
              <RouterLink to="/leaderboard" class="text-gray-400 hover:text-blue-400 transition-colors text-sm">
                Classement
              </RouterLink>
            </li>
          </ul>
      ...
      <div class="border-t border-gray-700 pt-8">
        <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div class="flex space-x-6">
            <a href="#" class="text-gray-400 hover:text-blue-400 transition-colors" aria-label="GitHub">
